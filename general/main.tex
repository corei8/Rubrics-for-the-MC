...
\chap{Low Mass}{
    ...
    \rubric Both acolytes kneel as the priest genuflects and the prayers at the
    foot of the altar begin.

    \rubric The acolytes must match the volume and speed of the priest, so far
    as is reasonable.
